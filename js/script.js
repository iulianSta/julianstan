...
const projects = [
    ...
    { title: 'ByteMarket – PHP E-Commerce Demo', desc: 'Modern e-commerce demo built with PHP featuring JSON product management, search, category filtering and a session-based shopping cart.', tags: ['PHP', 'JSON', 'Sessions', 'Tailwind CSS', 'Responsive'], icon: 'store', link: 'https://bytemarket.site.je/' },
